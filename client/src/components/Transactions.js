...
const TransactionsCard = ({ addressTo, addressFrom, timestamp, message, amount }) => {
  ...
  return (
    <div className="bg-[#180116] m-4 flex flex-1
      2xl:min-w-[450px]
      2xl:max-w-[500px]
      sm:min-w-[270px]
      sm:max-w-[300px]
    ...
    >
      <div className="flex flex-col items-center w-full mt-3  bg-[#9d0dba] ">
        <div className="display-flex justify-start w-full mb-6 p-2   bg-[#9d0dba]" >
        ...
        <div className="bg-black p-3 px-5 w-max rounded-3xl -mt-5 shadow-2xl">
          <p className="text-white bg-[#9d0dba] font-bold">{timestamp}</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions">
      <div className="flex flex-col md:p-12 py-12 px-4">
        {currentAccount ? (
          <h3 className="text-white text-3xl text-center my-2 text-decoration-line: underline;">
            Latest Transactions
          </h3>
        ) : (
          <h3 className="text-white text-3xl text-center my-2 text-decoration-line: underline;">
